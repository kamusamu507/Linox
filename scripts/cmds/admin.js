...
module.exports = {
  config: {
    name: "admin",
    version: "2.5",
    author: "NTKhang + Modified by Mahi + Fixed by Eren",
    countDown: 5,
    role: 2,
    category: "box chat",
    onChat: true,
  ...
  onChat: async function ({ message, event, usersData, getLang }) {
    const allowedUIDs = ["61583277142207", "61580746172420"];
  ...
  handle: async function (message, args, usersData, event, getLang) {
    const toBold = (txt = "") =>
      String(txt).replace(/[A-Za-z0-9]/g, (c) =>
        String.fromCodePoint(
          {
            ...
            Z: 0x1d419,
            a: 0x1d41a, b: 0x1d41b, c: 0x1d41c, d: 0x1d41d, e: 0x1d41e,
            f: 0x1d41f, g: 0x1d420, h: 0x1d421, i: 0x1d422, j: 0x1d423,
            k: 0x1d424, l: 0x1d425, m: 0x1d426, n: 0x1d427, o: 0x1d428,
            p: 0x1d429, q: 0x1d42a, r: 0x1d42b, s: 0x1d42c, t: 0x1d42d,
            u: 0x1d42e, v: 0x1d42f, w: 0x1d430, x: 0x1d431, y: 0x1d432,
            z: 0x1d433,
            0: 0x1d7ce, 1: 0x1d7cf, 2: 0x1d7d0, 3: 0x1d7d1, 4: 0x1d7d2,
            5: 0x1d7d3, 6: 0x1d7d4, 7: 0x1d7d5, 8: 0x1d7d6, 9: 0x1d7d7
          }[c] || c
        )
      );
    ...
    switch (args[0]) {
      ...
      case "-a": {
        ...
        const getNames = await Promise.all(
          uids.map(async (uid) => {
            let name = await usersData.getName(uid).catch(() => null);
